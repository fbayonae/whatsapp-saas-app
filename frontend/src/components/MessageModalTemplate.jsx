    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-white w-[90%] max-w-5xl rounded-lg shadow-lg flex p-6 gap-6">
        ...
        <div className="flex-1 border rounded p-4 bg-gray-50 shadow-inner">
          ...
          {header && <div className="text-gray-900 font-bold mb-2">{header}</div>}
          <div className="text-gray-800 mb-2">{body}</div>
          {footer && <div className="text-sm text-gray-500 italic">{footer}</div>}
