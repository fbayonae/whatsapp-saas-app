...
export default function CampaignEditModal({ campaignId, onClose }) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg max-w-5xl w-full p-6 space-y-6">
                {/* Cabecera de campaña */}
                ...
                <div>
                    ...
                    <div className="bg-white border rounded max-h-60 overflow-y-auto">
                        {campaign.contacts.map((c) => (
                            <div key={c.id} className="flex justify-between px-4 py-2 border-b">
